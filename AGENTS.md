...
- Commit policy: Only perform one git commit per explicit instance of the user asking you to commit. Bundle all staged changes into that single commit; do not make additional commits until asked again.

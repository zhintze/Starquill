...
namespace Crosstales.TrueRandom.EditorIntegration
{
   ...
   public static class TrueRandomMenu
   {
      [MenuItem("Tools/" + Constants.ASSET_NAME + "/Prefabs/" + Constants.TRUERANDOM_SCENE_OBJECT_NAME, false, EditorHelper.MENU_ID + 20)]
      private static void AddTrueRandom()
      {
         EditorHelper.InstantiatePrefab(Constants.TRUERANDOM_SCENE_OBJECT_NAME);
      }

      [MenuItem("Tools/" + Constants.ASSET_NAME + "/Prefabs/" + Constants.TRUERANDOM_SCENE_OBJECT_NAME, true)]
      ...
      private static void ShowInfo()
      {
         EditorUtility.DisplayDialog(Constants.ASSET_NAME + " - About",
            ...
            System.Environment.NewLine +
            "© 2016-2022 by " + Constants.ASSET_AUTHOR +
            System.Environment.NewLine +
            System.Environment.NewLine +
